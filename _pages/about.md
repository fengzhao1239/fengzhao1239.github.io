...
My research lies at the intersection of artificial intelligence and geoscience, advancing the energy transition to a sustainable, carbon-neutral future. I am interested in developing **AI-enabled computational frameworks** for subsurface energy systems, with applications to *geological carbon sequestration*, *shale gas exploitation*, and beyond. My CV is [here](docs/ZF_CV.pdf).
